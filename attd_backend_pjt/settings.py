...
SECRET_KEY = 'django-insecure-1ay^nz*1^2k*th@^b3!s)u(8)xqnukc9gho(jp0m_4o!m50x%j'
...
ROOT_URLCONF = 'attd_backend_pjt.urls'
...
WSGI_APPLICATION = 'attd_backend_pjt.wsgi.application'
